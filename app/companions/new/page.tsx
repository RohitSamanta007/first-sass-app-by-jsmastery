    ...
    <main className='min-lg:w-1/3 min-md:w-2/3 flex items-center justify-center'>
      ...
      <CompanionForm />
        ...
        <article className='companion-limit'>
          ...
          <p>You've reached your companion limit. Upgrade to create more comapnions and premium features</p>
          <Link href={"/subcription"} className='btn-primary w-full justify-center '>Upgrade My Plan</Link>
        </article>
      )
      }
    </main>
